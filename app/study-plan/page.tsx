...
export default function StudyPlanPage() {
 ...
 <div>
 <h1 className="text-3xl font-black text-white uppercase italic tracking-tighter">Exam Study Plan</h1>
 ...
 <label className="text-sm font-bold text-slate-500 uppercase tracking-wider">Exam Name</label>
 <input
 type="text"
 value={examName}
 ...
 <div className="space-y-2">
 <label className="text-sm font-bold text-slate-500 uppercase tracking-wider">Exam Date</label>
 <input
 type="date"
 value={examDate}
 ...
 <div className="space-y-2">
 <label className="text-sm font-bold text-slate-500 uppercase tracking-wider">Overall Progress</label>
 <div className="flex items-center gap-4">
 ...
 <span className={`px-3 py-1 rounded-lg text-sm font-bold uppercase border ${getPriorityColor(topic.priority)}`}>
 {topic.priority}
 </span>
 </div>
 ))}
 ...
 <p className="text-sm text-slate-500 font-bold uppercase">{resource.type}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <span className="text-sm text-slate-500 font-medium">{test.questions} questions</span>
 <span className="text-sm text-slate-500 font-medium">⏱️ {test.duration} min</span>
 </div>
 </div>
 ...
 <div>
 <p className="text-sm font-bold text-amber-400 uppercase tracking-wider mb-2">Study Tip</p>
 ...
 <Brain size={20} className="text-violet-400" />
 <p className="text-sm font-bold text-violet-400 uppercase">Total Topics</p>
 </div>
 ...
 <div className="flex items-center gap-3 mb-2">
 <BookOpen size={20} className="text-rose-400" />
 <p className="text-sm font-bold text-rose-400 uppercase">Resources</p>
 </div>
 ...
 <div className="flex items-center gap-3 mb-2">
 <FileText size={20} className="text-emerald-400" />
 <p className="text-sm font-bold text-emerald-400 uppercase">Practice Tests</p>
 </div>
 ...
 <p className="text-sm font-bold text-amber-400 uppercase">Days Until Exam</p>
 </div>
