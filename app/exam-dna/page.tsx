...
export default function ExamDNA() {
    ...
    const analyze = async () => {
        ...
        setPattern({
            topics: [
                { name: 'Thermodynamics & Heat Transfer', frequency: 5, avgMarks: 12, commandWords: ['Explain', 'Calculate', 'Derive'] },
                { name: 'Electromagnetism & Induction', frequency: 4, avgMarks: 10, commandWords: ['Describe', 'Prove', 'Sketch'] },
                { name: 'Quantum Mechanics Basics', frequency: 3, avgMarks: 8, commandWords: ['State', 'Explain', 'Apply'] },
                { name: 'Wave Optics & Diffraction', frequency: 4, avgMarks: 9, commandWords: ['Define', 'Derive', 'Compare'] },
                { name: 'Modern Physics Applications', frequency: 2, avgMarks: 6, commandWords: ['Discuss', 'Evaluate'] },
            ],
            commandWords: [
                { word: 'Explain', count: 18, markWeight: 8 },
                { word: 'Derive', count: 14, markWeight: 12 },
                { word: 'Calculate', count: 12, markWeight: 10 },
                { word: 'Describe', count: 10, markWeight: 6 },
                { word: 'State', count: 8, markWeight: 3 },
                { word: 'Compare', count: 6, markWeight: 7 },
            ],
            markDistribution: [
                { band: '1-3 marks (Short)', percentage: 25, color: 'bg-blue-500' },
                { band: '4-6 marks (Medium)', percentage: 30, color: 'bg-violet-500' },
                { band: '7-10 marks (Long)', percentage: 25, color: 'bg-amber-500' },
                { band: '11+ marks (Essay)', percentage: 20, color: 'bg-rose-500' },
            ],
            hotZones: [
                'Thermodynamics appears in EVERY paper — always 2-3 numerical questions',
                'Wave optics derivations are heavily marked — memorize Bragg\'s law',
                '"Derive" commands carry 40% of total marks across all papers',
                'Modern physics is a "bonus" section — 2 marks can swing grade boundaries',
            ],
            prediction: 'Based on 5-paper analysis: 89% probability of a Thermodynamics long answer (12 marks). Quantum mechanics section is overdue — appeared only once in last 4 years, high catch-up probability this year.',
        });
        setStatus('done');
    };
