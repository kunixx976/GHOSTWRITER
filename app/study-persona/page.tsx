...
export default function CognitiveProfile() {
 ...
 <div className={`text-3xl ${profile.color} flex justify-center`}>{profile.icon}</div>
 <div>
 <p className={`text-[10px] font-black uppercase tracking-[0.5em] mb-3 ${profile.color}`}>Your Cognitive Profile</p>
 <h1 className={`text-3xl font-black uppercase italic tracking-tighter leading-none bg-clip-text text-transparent bg-gradient-to-r ${profile.gradientFrom} ${profile.gradientTo}`}>
 {profile.title}
 </h1>
 </div>
 ...
 <h3 className="text-sm font-black text-slate-500 uppercase tracking-[0.4em]">How Ghostwriter Adapts For You</h3>
