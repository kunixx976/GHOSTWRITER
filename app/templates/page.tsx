...
export default function TemplatesPage() {
 ...
 <span className="text-sm font-black text-emerald-400 uppercase italic">99.4% Tier-1</span>
 </div>
 </div>
 </header>
 ...
 <h3 className="text-xl font-black text-white uppercase italic tracking-tighter group-hover:text-amber-400 transition-colors leading-[0.9]">{template.title}</h3>
