                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
                    ...
                    <div className="flex gap-4 p-4 bg-black/40 rounded-[2.5rem] border border-white/10 backdrop-blur-2xl shadow-2xl">
                        <div className="px-6 border-r border-white/10 flex flex-col">
                            ...
                            <span className="text-2xl font-black text-white italic tracking-tighter">{SAMPLE_QUESTIONS.length}</span>
                        </div>
                        <div className="px-6 flex flex-col">
                            <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-1">Total Marks</span>
                            <span className="text-2xl font-black text-amber-400 italic tracking-tighter">{SAMPLE_QUESTIONS.reduce((s, q) => s + q.marks, 0)}</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <AnimatePresence mode="wait">
                {!selectedQ ? (
                    ...
                    <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-8">
                        <h2 className="text-xs font-black text-slate-500 uppercase tracking-[0.4em]">Available Questions</h2>
                                    ...
                                    <div className="relative p-10 bg-[#0a0a0a] border border-white/5 rounded-[3rem] hover:border-amber-500/20 transition-all overflow-hidden shadow-2xl">
                                        ...
                                        <div className="flex items-start justify-between gap-8 mb-8">
                                            ...
                                            <div className="text-right shrink-0">
                                                <div className="text-4xl font-black text-amber-400 italic tracking-tighter leading-none">{q.marks}</div>
                                    ...
                                    <div className={`p-10 ${GRADE_CONFIG[result.grade].bg} border ${GRADE_CONFIG[result.grade].border} rounded-[3rem] relative overflow-hidden`}>
                                        <div className="flex items-center justify-between gap-8">
                                            <div className="space-y-3">
                                                ...
                                                <div className="text-7xl font-black italic tracking-tighter leading-none" style={{ color: 'white' }}>
                                            ...
                                            <div className="text-right space-y-2">
                                                <div className={`text-8xl font-black italic tracking-tighter ${GRADE_CONFIG[result.grade].text}`}>{result.grade}</div>
                                                <div className="text-2xl font-black text-white italic">{result.percentage}%</div>
                                            </div>
                                        </div>
                                    </div>
