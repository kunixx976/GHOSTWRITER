            ...
            <div className="flex items-center justify-between px-8 py-5 border-b border-white/5 bg-[#050505] shrink-0">
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h1 className="text-lg font-black text-white uppercase italic tracking-tighter">Knowledge Graph</h1>
                            <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Interactive Dependency Matrix</p>
                        </div>
                    </div>
                        ...
                        <motion.div initial={{ x: 340, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: 340, opacity: 0 }}
                            ...
                            <div className="flex items-start justify-between">
                                <div className="space-y-2">
                                    ...
                                    <h2 className="text-2xl font-black text-white uppercase italic tracking-tighter leading-none">{selectedNode.label}</h2>
                                </div>
