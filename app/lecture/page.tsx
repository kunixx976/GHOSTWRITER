...
export default function LecturePipeline() {
    ...
    const processPipeline = async () => {
        ...
        const mockData: ExtractedData = {
            topics: ['Photosynthesis Light Reactions', 'Calvin Cycle & Carbon Fixation', 'ATP Synthesis Mechanisms', 'Chlorophyll Absorption Spectra', 'C3 vs C4 Plants'],
            predictedQuestions: [
                { question: 'Explain the Z-scheme of electron transport in light reactions.', probability: 87, topic: 'Light Reactions' },
                { question: 'Compare the efficiency of C3 and C4 photosynthesis pathways.', probability: 74, topic: 'C3 vs C4 Plants' },
                { question: 'Describe how ATP is synthesized via the chemiosmotic gradient.', probability: 68, topic: 'ATP Synthesis' },
                { question: 'What is the role of RUBISCO in carbon fixation?', probability: 62, topic: 'Calvin Cycle' },
            ],
            vaultBlocks: [
                { title: 'Z-Scheme Electron Transport', content: 'System I (P700) and System II (P680) linked by the electron transport chain. Electrons energized by light move from water to NADP+.', category: 'concept', tags: ['Photosynthesis', 'Electrons', 'Light'] },
                { title: 'Calvin Cycle Steps', content: 'Carbon fixation → Reduction → Regeneration of RuBP. RUBISCO catalyzes CO₂ attachment to RuBP forming 2 × 3-PGA.', category: 'concept', tags: ['Calvin Cycle', 'RUBISCO', 'Carbon'] },
                { title: 'ATP Synthase Mechanism', content: 'Proton gradient drives ATP synthase (chemiosmosis). H⁺ flow through CF0-CF1 complex synthesizes ATP from ADP + Pi.', category: 'concept', tags: ['ATP', 'Chemiosmosis'] },
            ],
            summary: 'This lecture covers the complete photosynthesis pathway including light-dependent reactions in the thylakoid and light-independent reactions in the stroma. Key exam areas: Z-scheme, Calvin cycle stoichiometry, and C3/C4 comparisons.',
            keyFormulas: ['6CO₂ + 6H₂O + light → C₆H₁₂O₆ + 6O₂', 'ATP yield: 3 ATP per NADPH oxidized', 'Quantum yield = O₂ released / photons absorbed'],
        };
                                ...
                                <div className="flex flex-col items-center gap-8">
                                    ...
                                    {isRecording && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-2xl font-black text-rose-400 font-mono italic">{formatTime(recordingTime)}</span>
                    ...
                    <div className="p-10 rounded-[3rem] bg-rose-500/[0.03] border border-rose-500/10 space-y-6">
                        ...
                        {[
                            ...
                            <div key={s.step} className="flex items-center gap-4">
                                <span className="text-rose-500/30 font-black font-mono text-2xl italic tracking-tighter">{s.step}</span>
