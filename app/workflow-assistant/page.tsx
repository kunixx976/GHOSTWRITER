...
export default function WorkflowAssistant() {
 ...
 className="flex items-center gap-4 text-violet-400 font-bold uppercase tracking-[0.4em] text-[10px] "
 >
 ...
 <span className={`text-sm font-black uppercase italic ${stat.color}`}>{stat.value}</span>
 </div>
 ))}
 </div>
 </header>
 ...
 <h3 className="text-xl font-black text-white uppercase italic tracking-tighter animate-pulse ">Neural Sync in Progress</h3>
 ...
 <div className="flex items-center gap-4">
 <h3 className="text-sm font-black text-slate-500 uppercase tracking-[0.4em] italic whitespace-nowrap">Distillation Output</h3>
 ...
 <span className="text-sm font-black text-white uppercase tracking-widest">Executive Summary</span>
 </div>
 ...
 <h5 className="text-sm font-black text-white uppercase italic tracking-tight mb-2 leading-tight">{item.question}</h5>
