...
export default function PredictorPage() {
 ...
 className="flex items-center gap-4 text-emerald-400 font-bold uppercase tracking-[0.4em] text-[9px] ">
 <div className="w-6 h-[1px] bg-emerald-500/50" />
 AI Probability Analysis Engine v2.0
 </motion.div>
 <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
 className="text-[clamp(2.5rem,8vw,5rem)] font-black text-white uppercase italic tracking-tighter leading-[0.8] ">
 Exam <br />
 ...
 className="flex gap-4 p-4 bg-black/40 border border-white/10 rounded-[2rem] backdrop-blur-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)] relative group overflow-hidden ">
 ...
 <span className="text-[9px] font-black text-slate-500 uppercase tracking-[0.15em] mb-1 ">System Time</span>
 ...
 <h2 className="text-3xl font-black text-white italic tracking-tighter leading-[0.9] ">
 {results.subject}
 </h2>
 ...
 <h4 className="text-xl font-bold text-white uppercase italic tracking-tighter leading-[1.1] ">
 {p.question}
 </h4>
 </div>
 <div className="flex flex-col items-end shrink-0 ">
 <div className={`text-3xl font-black italic tracking-tighter leading-none bg-clip-text text-transparent bg-gradient-to-br ${getProbColor(prob)}`}>
 {prob}%
 </div>
 ...
 <div className="text-3xl font-black text-amber-500/10 font-mono italic tracking-tighter shrink-0 mt-1">
 ...
 <h5 className="text-lg font-bold text-white uppercase italic tracking-tighter group-hover:text-blue-400 transition-colors leading-tight ">{item.concept}</h5>
 <div className="text-3xl font-black text-white italic tracking-tighter leading-none shrink-0 ">{item.prob}%</div>
 </div>
 ...
 <div className="flex items-start justify-between gap-6 relative z-10">
 <h5 className="text-xl font-bold text-white uppercase italic tracking-tighter leading-tight ">{g.gap}</h5>
 ...
 <h3 className="text-xl font-black text-white uppercase italic tracking-tighter">Neural Recall Engine</h3>
 ...
 <p className="text-xl font-bold text-white italic leading-tight tracking-tight">{predictions[flashCardIndex]?.question}</p>
 ...
 <h4 className="text-xl font-black text-white uppercase italic tracking-tighter leading-tight">Neural Optimization Summary</h4>
 ...
 <div className="text-3xl font-black text-emerald-400 italic">8.2</div>
 <div className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Efficiency Score</div>
 </div>
 <div className="h-12 w-[1px] bg-white/10" />
 <div className="text-center">
 <div className="text-3xl font-black text-violet-400 italic">22</div>
 ...
 <div className="flex items-center gap-6">
 <div className="text-xl font-black text-slate-700 italic group-hover:text-indigo-400 transition-colors">{year}</div>
 <div>
 ...
 <span className="text-sm font-black text-white uppercase tracking-widest">Exam Prediction Report</span>
 </div>
 ...
 prose-h1:text-3xl prose-h1:mb-12 prose-h1:bg-gradient-to-r prose-h1:from-white prose-h1:to-white/40 prose-h1:bg-clip-text prose-h1:text-transparent
 prose-h2:text-xl prose-h2:mt-16 prose-h2:mb-8 prose-h2:text-violet-400/90
