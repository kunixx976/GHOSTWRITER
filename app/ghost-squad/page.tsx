...
export default function CollaborativeGhost() {
 ...
 <div className={`w-16 h-16 rounded-full ${member.color} flex items-center justify-center text-xl ring-4 ring-white/5 group-hover:ring-white/10 transition-all`}>
 {member.avatar}
 </div>
 ...
 <div className="space-y-3">
 <h3 className="text-xl font-black text-white uppercase italic tracking-tighter">Invite to Ghost Squad</h3>
